...
const DATA_WIDGET_HREF_PATTERN = /^https?:\/\/[^\s\u0000-\u001f\u007f-\u009f]+$/u;
...
const glyphsSchema = Type.Union([
  ...
  Type.Object(
    Object.fromEntries(
      FOOTER_ICON_FAMILIES.map((family) => [family, Type.Optional(Type.String())]),
    ),
...
function normalizeWidget(
  ...
  const description = sanitizeInlineText(widget.description ?? label, 512) || label;
